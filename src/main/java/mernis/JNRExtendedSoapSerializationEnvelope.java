...
public class JNRExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(JNRDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new JNRStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static JNRDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static JNRDateTimeConverter dateTimeConverter = new JNRStandardDateTimeConverter();

    public JNRExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public JNRExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new JNRMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=JNRHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,JNRExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=JNRHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
