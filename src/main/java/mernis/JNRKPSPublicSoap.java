...
public class JNRKPSPublicSoap
{
    ...
    public JNRKPSPublicSoap(){}

    public JNRKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JNRKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JNRExtendedSoapSerializationEnvelope envelope= new JNRExtendedSoapSerializationEnvelope(JNRExtendedSoapSerializationEnvelope.VER11);
